 ...
 * @author jshen
 */
public class DigitalMap extends MapDemoApp implements IReaderListener,
        IMapDrawingListener,IRoutingListener,IGeocodingListener {
    ...
    public DigitalMap() {
        ...
        MapConfiguration.setParameter(MapConfiguration.WORKER_THREAD_NUMBER, 1);
    ...
    private void initComponents() {
        ...
        setTitle("Guidebee GIS Engine Demo");
        setResizable(false);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(mapLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 786, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(49, 49, 49)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(txtAddress1, javax.swing.GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
                        .addComponent(txtAddress2, javax.swing.GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
                        .addGroup(layout.createSequentialGroup()
                            .addComponent(jLabel1)
                            .addGap(18, 18, 18)
                            .addComponent(cboMapType, 0, 141, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(mapLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 837, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(btnUp)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
    ...
    private void btnFindAddressActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindAddressActionPerformed
        if (!txtAddress.getText().isEmpty()) {
            ...
            try {
                name = com.mapdigit.util.HTML2Text.encodeutf8(name.getBytes("utf-8"));
            } catch (UnsupportedEncodingException ex) {
    ...
    private void mapLabelMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mapLabelMouseDragged
        System.out.println("mapLabelMouseMoved"+isPanMode);
        if(isPanMode)
        {
