...
////////////////////////////////////////////////////////////////////////////////
/**
 * Lwuit implemeation of the IGraphics interface.
 * <hr><b>&copy; Copyright 2009 Guidebee, Inc. All Rights Reserved.</b>
 * @version     1.00, 06/11/09
 * @author      Guidebee Pty Ltd.
 */
public class LWUITGraphics implements IGraphics {
     ...
     * @param graphics
     */
    public LWUITGraphics(Graphics graphics) {
    ...
    public void drawImage(IImage img, int x, int y) {
        graphics.drawImage(((LWUITImage) img).image, x, y);
    }
